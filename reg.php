                                            ...
                                            <div class="items">
                                                ...
                                                <div class="col-md-3">
                                                    <div style="text-align: center;">
                                                        <h3>Order Total</h3>
                                                        <h3><span style="color:green;">$<?php echo $brs['fee'].".00"; ?></span></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table class="table table-striped" style="font-weight: bold;">
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" value="<?php echo $urs['emtl']; ?>" name="email"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" value="<?php echo $urs['nmt']; ?>" name="first_name"
                                                           required="required" type="text"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" value="<?php echo $urs['snt']; ?>" name="last_name"
                                                           required="required" type="text"/>
                                                </td>
                                            </tr>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <a href="payNow.php?bus=<?php echo $_GET['bus']; ?>&user=<?php echo $urs['emtl']; ?>&order=<?php echo $_GET['order']; ?>" class="btn btn-success btn-lg" style="width:100%;">Pay Booking</a>
                                        <br/>
